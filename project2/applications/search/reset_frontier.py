...
from datamodel.search.AsbapatApushpenKbaijalKyuseony_datamodel import AsbapatApushpenKbaijalKyuseonyProjectionLink
...
@Deleter(AsbapatApushpenKbaijalKyuseonyProjectionLink)
@Getter(AsbapatApushpenKbaijalKyuseonyProjectionLink)
class DeleteFrontierFrame(IApplication):
    ...
    def update(self):
        ...
        ls = self.frame.get(AsbapatApushpenKbaijalKyuseonyProjectionLink)
        print "Found ", len(ls), " links to delete."
        for l in ls:
            self.frame.delete(AsbapatApushpenKbaijalKyuseonyProjectionLink, l)
