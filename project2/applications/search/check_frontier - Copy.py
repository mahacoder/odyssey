...
from datamodel.search.Testtester_datamodel import TesttesterProjectionLink
...
@Getter(TesttesterProjectionLink)
class CheckFrontierFrame(IApplication):

    def __init__(self, frame):
        self.starttime = time()
        self.app_id = "Testtester"
        self.frame = frame
    ...
    def update(self):
        ls = self.frame.get(TesttesterProjectionLink)
